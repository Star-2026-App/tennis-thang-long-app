// ======================================================
// GET /api/data/reconcile?month=8&year=2026 (v2.0) - Admin/Owner
// ======================================================
// Đối soát: tổng tính lại từ nguồn (Matches/GocLogs/QuyLogs...)
// phải khớp với snapshot MonthlyBalances đã chốt (P2).
// ======================================================
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    var result = await appsScript.callBusinessAction(sessionId, "reconcileMonth", { month: month, year: year });
