  ...
  try {
    ...
    switch (type) {
      ...
      case "performance": {
        ...
        // (mở rộng 06/09/2026) scope=monthlyBase -> perfGetMonthlyBase, phục vụ
        // ô "Điểm Base hiện tại" + chọn xem theo tháng trong tab "Phong độ".
        var perfAction = perfScope === "summary" ? "perfGetCurrentForm" :
          perfScope === "monthlyBase" ? "perfGetMonthlyBase" : "perfGetHistory";
